package com.maze.stulog.auth.infrastructure;
...
public class KakaoOAuthProvider {
    ...
    public KakaoUserInfo getUserInfo(String kakaoAccessToken) {
        ...
        throw new BusinessException(ExceptionCode.UNABLE_TO_GET_USER_INFO);
    }
    ...
    public String fetchKakaoAccessToken(String code) {
        ...
        return Optional.ofNullable(response.getBody())
                .orElseThrow(() -> new BusinessException(ExceptionCode.UNABLE_TO_GET_ACCESS_TOKEN))
                .getAccessToken();
    }
